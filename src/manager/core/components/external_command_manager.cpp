...
public:
    ManagerCommandMux()
        ...
        register_input("/dart/source/host_command", host_command_input_, false);
    ...
    void before_updating() override {
        ...
        if (!host_command_input_.ready()) {
            ...
            RCLCPP_WARN(
                logger_, "Failed to fetch \"/dart/source/host_command\". Set to empty string.");
        }
    }
    ...
    void update() override {
        ...
        *command_output_ = remote_command.empty() ? host_command : remote_command;
    }
